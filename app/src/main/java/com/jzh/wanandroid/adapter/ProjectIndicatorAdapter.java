...
/**
 * author:jzh
 * desc:project viewpager指示器 adapter
 * Date:2018/08/24 10:20
 * Email:jzh970611@163.com
 * Github:https://github.com/iLovT
 */

public class ProjectIndicatorAdapter extends CommonNavigatorAdapter {
    private List<ProjectTypeResponseData> datas;
    private ViewPager viewPager;

    public ProjectIndicatorAdapter(List<ProjectTypeResponseData> datas, ViewPager viewPager) {
        this.datas = datas;
