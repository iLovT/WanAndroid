...
public class Toasty {
    ...
    public static class Config {
        ...
        @CheckResult
        public Toasty.Config setTextColor(@ColorInt int textColor) {
            this.DEFAULT_TEXT_COLOR = textColor;
            return this;
        }

        @CheckResult
        public Toasty.Config setErrorColor(@ColorInt int errorColor) {
            this.ERROR_COLOR = errorColor;
            return this;
        }

        @CheckResult
        public Toasty.Config setInfoColor(@ColorInt int infoColor) {
            this.INFO_COLOR = infoColor;
            return this;
        }

        @CheckResult
        public Toasty.Config setSuccessColor(@ColorInt int successColor) {
            this.SUCCESS_COLOR = successColor;
            return this;
        }

        @CheckResult
        public Toasty.Config setWarningColor(@ColorInt int warningColor) {
